 ...
 void Sale_Details()
{
  ...
  void Update_Details()
  {
                      int Sel = 0,id = 0,Price = 0,Price_D = 0;
                      ...
                      else if(Sel == 2)
                      {
                          ...
                          Price_D = ((float)Shop[i].Battery_Price) * ( Price_D) / 100;

                          Shop[i].Total_Price = (Shop[i].Battery_Price) - ( Price_D);
